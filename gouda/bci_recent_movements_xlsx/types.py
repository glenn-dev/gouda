"""Source-native immutable result types for BCI Recent Movements."""
...
class SourceCell:
    """A workbook-local cell whose value is never included in repr output."""
...
class SourceRecord:
    ...
    source_amount: Decimal | None = field(default=None, repr=False)
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"outcome={self.outcome.value!r}, source_direction={self.source_direction!r})"
        )
